...
export default function MyOrders({ orders }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="My Orders — AgroSupply" />
            <div className="min-h-screen bg-gray-50 pb-12">
                <div className="bg-white border-b border-gray-200 px-8 py-5">
                    <h1 className="font-bold text-xl text-gray-800">My Orders</h1>
                    <p className="text-gray-500 text-sm mt-0.5">{orders.length} order(s) placed</p>
                </div>
                ...
                <div className="px-8 py-6 space-y-3">
                    {orders.length === 0 ? (
                        <div className="text-center py-20 text-gray-400">
                            ...
                            <div className="text-sm mt-1">Visit the Shop to place your first order.</div>
                        </div>
                    ) : orders.map(order => (
